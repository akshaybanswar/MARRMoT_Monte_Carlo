...
% NOTE: the names of all structure fields are hard-coded in each model
% file. These should not be changed.
input_solver.name              = 'createOdeApprox_EE';                      % Use Implicit Euler to approximate ODE's
...
figure('color','w'); 
    ...
    h(1) = plot(t,Q_Tua.discharge,'k','linewidth',2);
    for i = 1:length(model_list)
...
Q_obs = iddata(Q_Tua.discharge,[],86400);
Q_m_24_mopex1_5p_4s = iddata(results_sampling{2,3}.Q.',[],86400);
Q_m_25_tcm_6p_4s = iddata(results_sampling{3,3}.Q.',[],86400);
Q_m_26_flexi_10p_4s = iddata(results_sampling{4,3}.Q.',[],86400);
Q_m_28_xinanjiang_12p_4s = iddata(results_sampling{5,3}.Q.',[],86400);

compare(Q_obs, Q_m_24_mopex1_5p_4s,...
               Q_m_25_tcm_6p_4s,...
               Q_m_26_flexi_10p_4s,...
               Q_m_28_xinanjiang_12p_4s);  
