...
optim_settings = optimset(...                                               % Using 'optimset' ensures that all non-specified fields are included in the resulting settings structure
                    ...
                    'MaxIter',800,...                                      % Stop after this many iterations (default = 200*numPar)
                    'MaxFunEvals',800,...                                  % Stop after this many function evaluations (default = 200*numPar)
...
of_name      = 'of_inverse_KGE';                                                    % This function is provided as part of MARRMoT. See ./MARRMoT/Functions/Objective functions
...
time_cal_start  = 1;                % 01.01.72 (720259)
time_cal_end    = 9132;             % 31.12.96 (729390)
time_eval_start = 9133;             % 01.01.97 (729391)
time_eval_end   = 16437;            % 31.12.16 (736695)
