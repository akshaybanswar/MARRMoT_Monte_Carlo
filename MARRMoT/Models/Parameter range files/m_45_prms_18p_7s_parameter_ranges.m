...
txt.Properties.RowNames = {'tt, Temperature threshold for snowfall and melt [oC]' ...
                           'ddf,  Degree-day factor for snowmelt [mm/oC/d]' ...
                           'alpha, Fraction of rainfall on soil moisture going to interception [-] ' ...
                           'beta, Fraction of catchment where rain goes to soil moisture [-]' ...
                           'stor, Maximum interception capcity [mm]' ...
                           'retip, Maximum impervious area storage [mm]' ...
                           'fscn, Fraction of SCX where SCN is located [-]' ...
                           'scx, Maximum contributing fraction area to saturation excess flow [-]' ...
                           'flz, Fraction of total soil moisture that is the lower zone [-]' ...
                           'stot, Total soil moisture storage [mm]: REMX+SMAX' ...
                           'cgw, Constant drainage to deep groundwater [mm/d]' ...
                           'resmax, Maximum flow routing reservoir storage (used for scaling only, there is no overflow) [mm]' ...
                           'k1, Groundwater drainage coefficient [d-1]' ...
                           'k2, Groundwater drainage non-linearity [-]' ...
                           'k3, Interflow coefficient 1 [d-1]' ...
                           'k4, Interflow coefficient 2 [mm-1 d-1]' ...
                           'k5, Baseflow coefficient [d-1]' ...
                           'k6, Groundwater sink coefficient [d-1]'};
str = mfilename;                       
str(end-16:end) = [];
