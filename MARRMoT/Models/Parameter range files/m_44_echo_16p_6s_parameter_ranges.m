...
txt.Properties.RowNames = {'rho, Maximum interception storage [mm]' ...
                           'ts, Threshold temperature for snowfall [oC]' ...
                           'tm, Threshold temperature for snowmelt [oC]' ...
                           'as, Degree-day factor [mm/oC/d]' ...
                           'af, Refreezing reduction factor [-]' ...
                           'gmax, Maximum melt due to ground-heat flux [mm/d]' ...
                           'the, Water-holding capacity of snow [-]' ...
                           'phi, Maximum infiltration rate [mm/d]' ...
                           'smax, Maximum soil moisture storage [mm]' ...
                           'fsm, Plant stress point as a fraction of Smax [-]' ...
                           'fsw, Wilting point as fraction of sm [-]' ...
                           'ksat,  Runoff rate from soil moisture [d-1]' ...
                           'c, Runoff non-linearity from soil moisture [-]' ...
                           'lmax, Groundwater flux [mm/d]' ...
                           'kf, Runoff coefficient [d-1]' ...
                           'ks, Runoff coefficient [d-1]'};
str = mfilename;                       
str(end-16:end) = [];
