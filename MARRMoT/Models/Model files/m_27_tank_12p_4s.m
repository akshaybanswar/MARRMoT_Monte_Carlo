function [ fluxOutput, fluxInternal, storeInternal, waterBalance ] = ...
                m_27_tank_12p_4s( fluxInput, storeInitial, theta, solver )
% Hydrologic conceptual model: Tank Model
%
...
% E2(S2,max(0,Ep(t)- E1(S1,Ep(t),delta_t),delta_t): evaporation from store 2
E2 = evap_1;
...
fsolve_options = optimoptions('fsolve','Display','none',...                 % [1+n stores] settings of the root finding method
                              'JacobPattern', [1,0,0,0;
                                               1,1,0,0;
                                               1,1,1,0;
                                               1,1,1,1]);                   % Specify the Jacobian pattern                                               
...
% Model setup -------------------------------------------------------------
    ...
    tmpf_S4 = @(S1,S2,S3,S4) ...
                (F34(c0,S3) - ...
                 E4(S4,...
                    max(0,Ep(t)- E1(S1,Ep(t),delta_t)- E2(S2,max(0,Ep(t)- E1(S1,Ep(t),delta_t)),delta_t)- E3(S3,max(0,Ep(t)- E1(S1,Ep(t),delta_t)- E2(S2,max(0,Ep(t)- E1(S1,Ep(t),delta_t)),delta_t)),delta_t)),delta_t) - ...
...
% Model states and fluxes -------------------------------------------------    
    ...
    flux_f12(t) = F12(a0,tmp_sFlux(1));
    flux_f23(t) = F23(b0,tmp_sFlux(2));
    flux_f34(t) = F34(c0,tmp_sFlux(3));
    
    % Update the stores
    store_S1(t) = S1old + (P(t) - flux_e1(t) - flux_f12(t) - flux_y1(t) - flux_y2(t)) * delta_t;
    store_S2(t) = S2old + (flux_f12(t) - flux_e2(t) - flux_f23(t) - flux_y3(t)) * delta_t;    
