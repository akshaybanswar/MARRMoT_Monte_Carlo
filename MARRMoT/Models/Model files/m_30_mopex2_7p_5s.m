function [ fluxOutput, fluxInternal, storeInternal, waterBalance ] = ...
                m_30_mopex2_7p_5s( fluxInput, storeInitial, theta, solver )
% Hydrologic conceptual model: MOPEX-2
%
...
% ET2(S3,se,Ep(t),delta_t): evaporation from deeper store
ET2 = evap_7;
...
% Model states and fluxes -------------------------------------------------    
    ...
    flux_et2(t)  = ET2(tmp_sFlux(3),se,Ep(t),delta_t);
    ...
    store_S3(t) = S3old + (flux_qw(t) - flux_et2(t) - flux_q2u(t)) * delta_t;    
    store_S4(t) = S4old + (flux_q1f(t) - flux_qf(t)) * delta_t;    
