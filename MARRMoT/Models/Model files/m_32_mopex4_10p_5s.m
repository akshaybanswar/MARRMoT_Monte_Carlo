function [ fluxOutput, fluxInternal, storeInternal, waterBalance ] = ...
            m_32_mopex4_10p_5s( fluxInput, storeInitial, theta, solver )
% Hydrologic conceptual model: MOPEX-4
%
...
% Model states and fluxes -------------------------------------------------    
    ...
    flux_i(t)    = I(i_alpha,i_s,t,tmax,PR(P(t),T(t),tcrit),delta_t);
    ...
    store_S2(t) = S2old + (flux_pr(t) + flux_qn(t) - flux_et1(t) - ...
                           flux_i(t) - flux_q1f(t) - flux_qw(t)) * delta_t;
